...
| 43 | Conscious selection / jackpot sharing (kb card 28, decision layer; `src/csi_popularity.py`, 984 official draws, within-game stratified) | T1 = Δ standardized CSI (winner vs no-winner draws); T2 = rank corr(CSI, winning bets) | 0 / 0 (null trial 0.001±0.112 / 0.000±0.031) | +0.736 sd / +0.162 | **5e-05 / 1e-04** (floor; Šidák m=2 0.0253) — popularity predicts official jackpot sharing 2.8× top vs bottom tertile; a claim about PLAYERS, not the draw; EXPLORATORY G0 |
| 44 | Draw-paired strategy backtest (`src/pcso_strategy_backtest.py`, 834 draws × 2 tickets, sign-flip null, m=7) | Δ matches/ticket vs uniform on the same draws | 0 | v1 +0.0040 (p .0061), v2 +0.0081 (.014), cold −0.041 (.010), hot/overdue/repeat/Markov n.s. | one flag (v1) traced to this year's >31 marginal excess (z +2.12, n.s.) and charged once with the χ² class; no rule changes P(match); G0, replication required |
