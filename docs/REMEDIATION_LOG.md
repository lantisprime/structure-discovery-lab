...
| **M6** no global ledger | **FIXED** | `src/meta_uniformity.py` panel v2, now part of the output contract | **Panel v2.1 (2026-07-02, sha 67eaafb4248d72b7): 126 lotto-side real-data p-values, discrete-lattice meta p=0.044, 10.3% ≤0.05 (sim band 2.4–8.7%), 1.6% ≤0.01 — the panel now FLAGS a small-p excess.** The excess is robust to composition (8.9–10.9% across four registered alternatives) and concentrates in the traced #45 family (6/55 λ_max 0.001 / 0.0025-at-floor, 6/45 λ_max 0.015, 6/55 half-corr 0.025); dropping the 6/55 λ_max rows returns the panel to the band edge (8.9%). Earlier transcription (126 / KS 0.385 / 6.3%) was stale against the JSON — AUDIT_CORRECTNESS_2026-07-02.md M-5/M-6, adversarial review M5 (fig9) |
