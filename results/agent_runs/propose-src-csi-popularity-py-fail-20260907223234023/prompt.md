...
```json
{
 ...
 "artifact": "src/csi_popularity.py",
 "artifact_class": "instrument",
 "signal": "FAIL",
 "evidence": "VERIFY MISMATCH: regenerated bytes differ from /Users/charltonho/Developer/projects/structure-discovery-lab/results/csi_popularity_2026-09-06.json",
 "detail": {
  "args": [
   "--verify"
  ],
...
```json
{
 "defect_commit": "a03a518",
 "defect_key": "verify_entrypoint|src/csi_popularity.py|FAIL|068f9705b4e908e2e5afc8e04228b4eae8a3eea7dfec399d491096856f519814",
 "introduced_by": "a03a518",
 "last_good": "26b5fd3",
 "method": "bisect",
 "platform": "darwin",
 "steps": [
