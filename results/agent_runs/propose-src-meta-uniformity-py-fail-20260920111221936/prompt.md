...
```json
{
 "defect_commit": "309cb43",
 "defect_key": "replay|src/meta_uniformity.py|FAIL|5053118fed0a6b3cf339ad6c1ec036e6d6203d0355c3efc9881597db395cf40b",
...
- src/meta_uniformity.py FAIL (results/meta_uniformity.json drifted: committed 021c37dd… regenerated 3d696051…); introduced by 9488a9a via merge 1aff3dc; passing again at ea3b159 on darwin
...
- src/source_drift_check.py ERROR (exit 0 without a PASS sha256 line); introduced by unknown; passing again at ea3b159 on darwin
- src/pcso_monitoring_run.py FAIL (ValueError: verification mismatch: generated bytes differ from /Users/charltonho/Developer/projects/structure-discovery-); introduced by unknown; passing again at 9ce6066 on darwin
